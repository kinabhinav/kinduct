...
public class CreatingProgramTemplate {
...
public void CreateTrainingProgram() throws Exception 
	...
	//	driver.findElement(By.xpath(".//*[@id='schedule']/tbody/tr/td[1]/div/ul/li/div[2]/ul/li/div[1]/div/div/span/span")).click();
		...
		//w.isElementHiddenNow(".//*[@id='u4wqukbnkuf8h6b7']/div/a",driver);
		//driver.findElement(By.xpath(".//*[@id='u4wqukbnkuf8h6b7']/div/a")).click();
		
		driver.findElement(By.partialLinkText("Edit exercises")).click();
		Thread.sleep(1000);
		
		// 
		
		w.isElementHiddenNow(".//*[@id='img_perf_three_point_lunge|11739']",driver);
